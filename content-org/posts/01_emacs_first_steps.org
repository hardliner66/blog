...
So if you're like me and always forget to track your time at work, there even is an org-mode plugin called [[https://github.com/ahungry/org-jira][org-jira]], which can not only
...
using org-mode. And if org-mode is too much at first, try [[https://www.orgroam.com/][org-roam]] instead. Org-roam gives you a nice local knowledge-base system, which can also show you back-links
